...
execute_process(
  COMMAND "C:/Program Files/Git/mingw64/bin/git.exe" show-ref "v1.0.1"
  WORKING_DIRECTORY "D:/Tmp/CPP_WorkSpaces/Cmake/test_subprj/build/_deps/gridobject-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'D:/Tmp/CPP_WorkSpaces/Cmake/test_subprj/build/_deps/gridobject-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'D:/Tmp/CPP_WorkSpaces/Cmake/test_subprj/build/_deps/gridobject-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
